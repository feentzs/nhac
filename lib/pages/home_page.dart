...
import 'package:nhac/components/home_content.dart'; // Certifique-se de importar o arquivo do componente
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Alteração aqui: Lógica para trocar de tela
      body: _selectedIndex == 0 
          ? const HomeContent() // Se o index for 0, mostra seu novo componente
          : _buildPlaceholderContent(), // Caso contrário, mostra o que estava antes

      bottomNavigationBar: _buildFloatingNavBar(),
    );
  }

  // Criei esta função apenas para manter o design antigo nas outras abas
